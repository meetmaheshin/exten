...
export async function buildApp(env: Env, db: Database) {
  ...
  app.get("/api/version", async () => ({
    extension: { version: "0.2.21", downloadUrl: "https://apivscode.ailancers.com/dashboard/downloads/" },
    desktop: { version: "0.2.21", downloadUrl: "https://apivscode.ailancers.com/dashboard/downloads/" },
  }));
